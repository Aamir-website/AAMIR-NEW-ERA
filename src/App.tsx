      ...
      >
        ...
        >
          <div className="w-full text-center">
            <h1 
              className="text-3xl md:text-6xl lg:text-6xl text-white/30 leading-none opacity-0 animate-fade-in-delayed"
              style={{ 
        ...
        {showTestimonials && (
          <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden transform -translate-y-40">
